										...
										<div class="table-responsive ">
											<table class="table patient-activity">
												<tr>
													<td>
														<div class="media align-items-center flex-wrap">
															<img class="me-3 img-fluid rounded" width="78" src="{{asset('admin/images/avatar/1.jpg')}}"  alt="DexignZone">
												...
												<tr>
													<td>
														<div class="media align-items-center flex-wrap">
															<img class="me-3 img-fluid rounded" width="78" src="{{asset('admin/images/avatar/2.jpg')}}"  alt="DexignZone">
															<div class="media-body">
												...
												<tr class="active">
													<td>
														<div class="media align-items-center flex-wrap">
															<img class="me-3 img-fluid rounded" width="78" src="{{asset('admin/images/avatar/3.jpg')}}"  alt="DexignZone">
															<div class="media-body">
												...
												<tr>
													<td>
														<div class="media align-items-center flex-wrap">
															<img class="me-3 img-fluid rounded" width="78" src="{{asset('admin/images/avatar/4.jpg')}}"  alt="DexignZone">
															<div class="media-body">
												...
												<tr>
													<td>
														<div class="media align-items-center flex-wrap">
															<img class="me-3 img-fluid rounded" width="78" src="{{asset('admin/images/avatar/5.jpg')}}"  alt="DexignZone">
															<div class="media-body">
												...
												<tr>
													<td>
														<div class="media align-items-center flex-wrap">
															<img class="me-3 img-fluid rounded" width="78" src="{{asset('admin/images/avatar/6.jpg')}}"  alt="DexignZone">
															<div class="media-body">
											...
											<ul class="timeline">
													...
													<div class="timeline-panel d-flex align-items-center justify-content-between flex-wrap">
														<div class="d-flex">
															<div class="media me-4">
																<img alt="image" width="90" src="{{asset('admin/images/avatar/1.jpg')}}" >
												...
												<li>
													<div class="timeline-panel active d-flex align-items-center justify-content-between flex-wrap">
														<div class="d-flex">
															<div class="media me-4">
																<img alt="image" width="90" src="{{asset('admin/images/avatar/2.jpg')}}" >
												...
												<li>
													<div class="timeline-panel d-flex align-items-center justify-content-between flex-wrap">
														<div class="d-flex">
															<div class="media me-4">
																<img alt="image" width="90" src="{{asset('admin/images/avatar/3.jpg')}}" >
												...
												<li>
													<div class="timeline-panel d-flex align-items-center justify-content-between flex-wrap">
														<div class="d-flex">
															<div class="media me-4">
																<img alt="image" width="90" src="{{asset('admin/images/avatar/4.jpg')}}" >
												...
												<li>
													<div class="timeline-panel d-flex align-items-center justify-content-between flex-wrap">
														<div class="d-flex">
															<div class="media me-4">
																<img alt="image" width="90" src="{{asset('admin/images/avatar/5.jpg')}}" >
